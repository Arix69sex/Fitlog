...
function Goals() {
    ...
    return (
        <div className="w-screen h-screen flex flex-row justify-center items-center bg-primary-grey">
            ...
            <div className="transform w-1/5 h-3/5 flex flex-col rounded-2xl justify-center align-center bg-dark-blue mr-24 opacity-75 transition ease-in-out delay-150 hover:scale-110 hover:bg-accent-blue hover:opacity-100 hover:-translate-y-14 duration-300">
